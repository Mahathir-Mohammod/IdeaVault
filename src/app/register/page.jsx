    ...
    <>
      <style>{`
        ...
        .auth-subtext {
          ...
          margin:0.4rem 0 1.5rem; font-weight:300; transition:color 0.3s;
        }
        ...
        .field-label-opt {
          font-size:0.72rem; color:var(--auth-label-opt);
          font-weight:400; margin-left:4px; transition:color 0.3s;
        }
        ...
        .auth-input.input-ok  { border-color:var(--auth-ok-bd); background:var(--auth-ok-bg); }
        .auth-input.input-err { border-color:var(--auth-err-bd); background:var(--auth-err-bg); }
        ...
        .pw-rules {
          ...
          background:var(--auth-rule-bg); border:1px solid var(--auth-rule-bd);
          border-radius:8px; margin-top:4px;
          transition:background 0.3s,border-color 0.3s;
        }
        .rule-item {
          display:flex; align-items:center; gap:7px;
          font-size:0.78rem; transition:color 0.25s;
        }
        .rule-item.passed { color:var(--auth-rule-passed); }
        .rule-item.failed { color:var(--auth-rule-failed); }
        .rule-dot {
          width:14px; height:14px; border-radius:50%;
          display:flex; align-items:center; justify-content:center; flex-shrink:0;
          transition:background 0.25s;
        }
        .rule-dot.passed { background:var(--auth-rule-dot-ok); }
        .rule-dot.failed { background:var(--auth-rule-dot-fail); }

        .match-hint {
          font-size:0.75rem; margin-top:3px;
          display:flex; align-items:center; gap:5px;
        }
        .match-hint.ok  { color:var(--auth-match-ok); }
        .match-hint.bad { color:var(--auth-match-bad); }
